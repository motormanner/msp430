...
int gear_2_l=100;//156 
int gear_2_h=250;

int gear_3_l=250;//398 
int gear_3_h=500;

int gear_4_l=500;//650
int gear_4_h=730;

int gear_5_l=730;//882
int gear_5_h=930;

int gear_6_l=1010;//1022
int gear_6_h=1024;

int gear_n_l=930;//1000
int gear_n_h=1010;
...
void loop() {
  ...
  */
int gang_input=analogRead(A0);
  
 if( gang_input>=gear_1_l and gang_input<=gear_1_h){
 gear_position=1;
 }
 else if( gang_input>=gear_2_l and gang_input<=gear_2_h){
 gear_position=2; 
 }
 else if( gang_input>=gear_3_l and gang_input<=gear_3_h){
 gear_position=3; 
 }
 else if( gang_input>=gear_4_l and gang_input<=gear_4_h){
 gear_position=4; 
 }
 else if( gang_input>=gear_5_l and gang_input<=gear_5_h){
 gear_position=5; 
 }
 else if( gang_input>=gear_6_l and gang_input<=gear_6_h){
 gear_position=6; 
 }
 else if( gang_input>=gear_n_l and gang_input<=gear_n_h){
 gear_position=0; 
 }
  
  lcd.setCursor(9, 0, 2);
  lcd.print(gear_position);
